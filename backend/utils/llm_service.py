...
async def get_embedding(text: str, model: str = "text-embedding-3-small") -> list:
    """
    Get embeddings for the given text using the OpenAI API.
...
"""
# Synchronous usage
response = generate_gpt_response("Hello, how are you?")

# Async usage
async def main():
    response = await generate_gpt_response_async("Hello, how are you?")
    embedding = await get_embedding("Some text to embed")
